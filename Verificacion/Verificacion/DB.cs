...
namespace Verificacion
{
    public class DB
    {
        ...
        public bool abrirConexion()
        {
            ...
            {
                MessageBox.Show(ex.Message.ToString()+" "+parametrosConexion);
                return false;
            }
        }
        ...
        public bool backDoor(string query,bool MostrarmensajeBool) {
            abrirConexion();
            queryCommand = new SQLiteCommand(query,conexionBD);
            try
            {
      ...
      /*  public List<T> valuesMultiInsert<T>()
        {
